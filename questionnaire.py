    ...
    <body><div class="container">
        ...
        <form action="/predict" method="post">
           ...
           <label>Autism in immediate family?</label>
            <div class="radio-group">
                <label><input type="radio" name="autism" value="1" required> Yes</label>
                <label><input type="radio" name="autism" value="0"> No</label>
            </div>

            <label>Jaundice (in infancy)?</label>
            <div class="radio-group">
                <label><input type="radio" name="jaundice" value="1" required> Yes</label>
                <label><input type="radio" name="jaundice" value="0"> No</label>
            </div>

            <label>Used this app before?</label>
            <div class="radio-group">
                <label><input type="radio" name="used_app_before" value="1" required> Yes</label>
                <label><input type="radio" name="used_app_before" value="0"> No</label>
            </div>
